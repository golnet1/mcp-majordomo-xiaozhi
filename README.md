...
Этот проект обеспечивает полный мост между **[MajorDoMo](https://github.com/sergejey/majordomo)** (открытой системой автоматизации дома) и **ИИ-агентами** с использованием протокола **MCP**. Включает:
